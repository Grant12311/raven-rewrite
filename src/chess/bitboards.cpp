...
U64 eastOne(U64 BB) { return (BB << 1) & ~BBfileA; }
...
U64 soEaOne(U64 BB) { return (BB >> 7) & ~BBfileA; }
U64 soWeOne(U64 BB) { return (BB >> 9) & ~BBfileH; }
U64 noEaOne(U64 BB) { return (BB << 9) & ~BBfileA; }
U64 noWeOne(U64 BB) { return (BB << 7) & ~BBfileH; }
